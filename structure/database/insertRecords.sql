...
INSERT INTO NBUSER.INGREDIENTLIST (MEAL_ID, INGREDIENT_ID, QUANTITY) 
	...
	INSERT INTO NBUSER."ORDER" ("STATUS", "TYPE", PAYMENT_ID, CUST_ID) 
...
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-01', '16:55:34', 10.0, 1, 1);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-06', '16:55:34', 15.0, 1, 1);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-14', '16:55:34', 30.0, 1, 2);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-02', '16:55:34', 30.0, 1, 5);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-06', '16:55:34', 15.0, 2, 3);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-13', '16:55:34', 30.0, 2, 3);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-08', '16:55:34', 50.0, 2, 5);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-15', '16:55:34', 30.0, 2, 4);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-22', '16:55:34', 50.0, 3, 4);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-18', '16:55:34', 100.0, 3, 4);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-25', '16:55:34', 30.0, 3, 5);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-04', '16:55:34', 50.0, 3, 5);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-28', '16:55:34', 30.0, 4, 2);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-07', '16:55:34', 30.0, 4, 2);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-14', '16:55:34', 15.0, 4, 1);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-02-22', '16:55:34', 15.0, 4, 1);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-01', '16:55:34', 10.0, 5, 3);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-08', '16:55:34', 10.0, 5, 3);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-12', '16:55:34', 10.0, 5, 4);
INSERT INTO NBUSER.RELOAD ("DATE", "TIME", AMOUNT, CUST_ID, STAFF_ID) 
	VALUES ('2019-03-21', '16:55:34', 15.0, 5, 1);
