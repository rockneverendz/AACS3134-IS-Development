                ...
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-secondary btn-lg active">
                            <input type="radio" name="options" id="option1" autocomplete="off" checked> Paid
                        </label>
                                ...
                                <table class="table" width="100%" cellspacing="0" role="grid" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="table-secondary cat<%= i%>" style="display:none">
                                            <td>
                                                <a href="../order/cancelOrder?orderId=<%= order.getOrderId() %>" class="btn btn-outline-danger btn-sm" role="button" >
